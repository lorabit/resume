  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Computer Science;  Advisor: Prof. Yi Zhang}{Sep. 2016 -- Dec. 2017(expected)}
       \resumeItemListStart
        \resumeItem{Major courses:}{Algorithm Analysis, Image Processing and Computer Vision, Design Database Systems, Computational Model of Discourse and Dialog, Programming Languages}
        \resumeItemListEnd
    \resumeSubheading
