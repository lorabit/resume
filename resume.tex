...
\section{Experience}
  ...
  \resumeSubheading
      ...
      {Software Engineer}{Mar 2019 - Current}
      \resumeItemListStart
        \resumeItem{Conversation Engine}  
          {Developing a conversational vertical solution.}
        \resumeItem{Document Understanding Infra}  
          {Building the infrastructure for supporting document understanding at scale.}
      \resumeItemListEnd
      
  \resumeSubheading
      {Rulai}{Campbell, California}
      {Senior Research Engineer}{Feb 2018 - Mar 2019}
      \resumeItemListStart
        \resumeItem{Multi-Round Conversational Database Querying}  
          {Designing and developing an easy-to-use product for designing data querying chatbot with dynamic flows.}
        \resumeItem{Question Answering with Knowledge Graph}  
          {Exploring the latest natural language processing and machine learning techniques to build Rulai's knowledge graph module enabling chatbots to answer questions based on knowledge graphs. }
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Data Migration}
          {Designed the process to migrate a table that was heavily used by multiple products from a Google's internal KVS to another internal DBMS - Spanner with zero downtime. The table serves several applications with different data consistency requirements. Developed and launched an independent service that is used as an intermediary layer between applications and database to hide database migration process from applications.}
        \resumeItem{Data Processing}  
          {Used Google's processing tools to process massive log data.}
      \resumeItemListEnd

    \resumeSubheading
      {Hangzhou From Network Technology}{Hangzhou, China}
      {Software Engineer}{Aug 2015 - Aug 2016}
      \resumeItemListStart
    ...
    \resumeSubheading
      {Taobao}{Hangzhou, China}
      {Software Engineer}{Jun 2014 - April 2015}
      \resumeItemListStart
