  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Database Migration}
          {Designed and built a service in Java based on Google's internal microservices platform - Boq,  as an intermediary layer from application to database to hide dabase migration process from application side.}
